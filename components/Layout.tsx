...
export const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-gray-100">
      <nav className="bg-black bg-opacity-80 backdrop-filter backdrop-blur-md border-b border-indigo-900/30 shadow-lg shadow-indigo-500/20 sticky top-0 z-50">
  ...
  <div className="flex justify-between items-center h-16">
    ...
    <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center">
      <Link href="/MainPage" className="flex items-center">
        ...
        <svg className="h-8 w-8 ml-2 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
